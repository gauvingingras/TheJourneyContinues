...
{
    public abstract class _BaseSpearProjectile : _BaseProjectile
    {
        protected abstract float Speed { get; }

        protected sealed override void SetProjectileDefaults()
        {
            ...
            SetSpearProjectileDefaults();
        }

        protected virtual void SetSpearProjectileDefaults() { }
        ...
        // Code borrowed and adapted from Example Mod
        public override void AI()
        {
            ...
            if (!projOwner.frozen)
            {
                ...
                {
                    MovementFactor = Speed; // Make sure the spear moves forward when initially thrown out
